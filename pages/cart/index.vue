<template>
  <div>
    ...
    <div class="text-center" v-if="$store.state.cart.cart.length == 0">
      <v-img class="d-block mx-auto my-8" src="/emptycart.svg" width="128"></v-img>
      <p>There are no items in your cart.</p>
      <p @click="$router.push('/products')" class="blue--text pointer">← Go back to products</p>
    </div>
    <v-container>
      <div class="mb-8" v-if="$store.state.cart.cart.length > 0">
        <v-btn
          nuxt
          to="/cart/confirm"
          min-width="150"
              ...
              <v-row dense>
                ...
                <v-col class="pl-5 pt-2" md="9">
                  ...
                  <v-btn
                    ...
                    icon
                  >
                    <v-icon size="24">mdi-minus-circle</v-icon>
                  </v-btn>
